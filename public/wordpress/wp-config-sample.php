...
define('WP_SITEURL', 'http://pi-wp.local');
define('WP_HOME', 'http://pi-wp.local/');

// ** MySQL settings - You can get this info from your web host ** //
/** The name of the database for WordPress */
define( 'DB_NAME', 'pi_wp_local' );

/** MySQL database username */
define( 'DB_USER', 'root' );

/** MySQL database password */
define( 'DB_PASSWORD', 'Asdfgh1@3' );
...
define( 'IDP_CLIENT_ID', 'PublicBI' );
define( 'IDP_CLIENT_SECRET', 'g7C1d6MQ5vnidkEx48sSWNOdWSsJcnC2gsxpQv3Y' );
define( 'REDIRECT_URI', 'http://pi-wp.local/auth/callback' );
define( 'URL_AUTHORIZE', 'https://test-idpserver-doublecheck.azurewebsites.net/connect/authorize' );
define( 'URL_ACCESS_TOKEN', 'https://test-idpserver-doublecheck.azurewebsites.net/connect/token' );
define( 'URL_GET_USER_INFO', 'https://test-idpserver-doublecheck.azurewebsites.net/connect/userinfo' );
